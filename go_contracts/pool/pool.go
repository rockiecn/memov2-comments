...
const PoolABI = "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_a\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"address\",\"name\":\"from\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"bool\",\"name\":\"isSet\",\"type\":\"bool\"}],\"name\":\"AddOwner\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"from\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"tAddr\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"money\",\"type\":\"uint256\"}],\"name\":\"Inflow\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"to\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"tAddr\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"money\",\"type\":\"uint256\"}],\"name\":\"Outflow\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_a\",\"type\":\"address\"},{\"internalType\":\"bool\",\"name\":\"isSet\",\"type\":\"bool\"},{\"internalType\":\"bytes[5]\",\"name\":\"signs\",\"type\":\"bytes[5]\"}],\"name\":\"add\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"auth\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"tAddr\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"from\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"money\",\"type\":\"uint256\"}],\"name\":\"inflow\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"tAddr\",\"type\":\"address\"},{\"internalType\":\"address\",\"name\":\"to\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"money\",\"type\":\"uint256\"}],\"name\":\"outflow\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"owners\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"version\",\"outputs\":[{\"internalType\":\"uint16\",\"name\":\"\",\"type\":\"uint16\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"stateMutability\":\"payable\",\"type\":\"receive\"}]"

// PoolFuncSigs maps the 4-byte function signature to its string representation.
var PoolFuncSigs = map[string]string{
	"4bf1b134": "add(address,bool,bytes[5])",
	"de9375f2": "auth()",
	"368007fe": "inflow(address,address,uint256)",
	"530345bb": "outflow(address,address,uint256)",
...
var PoolBin = ""

// DeployPool deploys a new Ethereum contract, binding an instance of Pool to it.
func DeployPool(auth *bind.TransactOpts, backend bind.ContractBackend, _a common.Address) (common.Address, *types.Transaction, *Pool, error) {
	parsed, err := abi.JSON(strings.NewReader(PoolABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(PoolBin), backend, _a)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
//
// Solidity: function auth() view returns(address)
func (_Pool *PoolCaller) Auth(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Pool.contract.Call(opts, &out, "auth")
...
//
// Solidity: function auth() view returns(address)
func (_Pool *PoolSession) Auth() (common.Address, error) {
	return _Pool.Contract.Auth(&_Pool.CallOpts)
}

// Auth is a free data retrieval call binding the contract method 0xde9375f2.
//
// Solidity: function auth() view returns(address)
func (_Pool *PoolCallerSession) Auth() (common.Address, error) {
	return _Pool.Contract.Auth(&_Pool.CallOpts)
}
...
//
// Solidity: function owners(address ) view returns(bool)
func (_Pool *PoolCaller) Owners(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var out []interface{}
	err := _Pool.contract.Call(opts, &out, "owners", arg0)
...
//
// Solidity: function owners(address ) view returns(bool)
func (_Pool *PoolSession) Owners(arg0 common.Address) (bool, error) {
	return _Pool.Contract.Owners(&_Pool.CallOpts, arg0)
}

// Owners is a free data retrieval call binding the contract method 0x022914a7.
//
// Solidity: function owners(address ) view returns(bool)
func (_Pool *PoolCallerSession) Owners(arg0 common.Address) (bool, error) {
	return _Pool.Contract.Owners(&_Pool.CallOpts, arg0)
}
...
func (_Pool *PoolCaller) Version(opts *bind.CallOpts) (uint16, error) {
	var out []interface{}
...
//
// Solidity: function version() view returns(uint16)
func (_Pool *PoolSession) Version() (uint16, error) {
...
//
// Solidity: function version() view returns(uint16)
func (_Pool *PoolCallerSession) Version() (uint16, error) {
	return _Pool.Contract.Version(&_Pool.CallOpts)
}
...
//
// Solidity: function add(address _a, bool isSet, bytes[5] signs) returns()
func (_Pool *PoolTransactor) Add(opts *bind.TransactOpts, _a common.Address, isSet bool, signs [5][]byte) (*types.Transaction, error) {
	return _Pool.contract.Transact(opts, "add", _a, isSet, signs)
}

// Add is a paid mutator transaction binding the contract method 0x4bf1b134.
//
// Solidity: function add(address _a, bool isSet, bytes[5] signs) returns()
func (_Pool *PoolSession) Add(_a common.Address, isSet bool, signs [5][]byte) (*types.Transaction, error) {
	return _Pool.Contract.Add(&_Pool.TransactOpts, _a, isSet, signs)
}

// Add is a paid mutator transaction binding the contract method 0x4bf1b134.
//
// Solidity: function add(address _a, bool isSet, bytes[5] signs) returns()
func (_Pool *PoolTransactorSession) Add(_a common.Address, isSet bool, signs [5][]byte) (*types.Transaction, error) {
	return _Pool.Contract.Add(&_Pool.TransactOpts, _a, isSet, signs)
}
...
//
// Solidity: function inflow(address tAddr, address from, uint256 money) payable returns()
func (_Pool *PoolTransactor) Inflow(opts *bind.TransactOpts, tAddr common.Address, from common.Address, money *big.Int) (*types.Transaction, error) {
	return _Pool.contract.Transact(opts, "inflow", tAddr, from, money)
}

// Inflow is a paid mutator transaction binding the contract method 0x368007fe.
//
// Solidity: function inflow(address tAddr, address from, uint256 money) payable returns()
func (_Pool *PoolSession) Inflow(tAddr common.Address, from common.Address, money *big.Int) (*types.Transaction, error) {
	return _Pool.Contract.Inflow(&_Pool.TransactOpts, tAddr, from, money)
}

// Inflow is a paid mutator transaction binding the contract method 0x368007fe.
//
// Solidity: function inflow(address tAddr, address from, uint256 money) payable returns()
func (_Pool *PoolTransactorSession) Inflow(tAddr common.Address, from common.Address, money *big.Int) (*types.Transaction, error) {
	return _Pool.Contract.Inflow(&_Pool.TransactOpts, tAddr, from, money)
}
...
//
// Solidity: function outflow(address tAddr, address to, uint256 money) payable returns()
func (_Pool *PoolTransactor) Outflow(opts *bind.TransactOpts, tAddr common.Address, to common.Address, money *big.Int) (*types.Transaction, error) {
	return _Pool.contract.Transact(opts, "outflow", tAddr, to, money)
}

// Outflow is a paid mutator transaction binding the contract method 0x530345bb.
//
// Solidity: function outflow(address tAddr, address to, uint256 money) payable returns()
func (_Pool *PoolSession) Outflow(tAddr common.Address, to common.Address, money *big.Int) (*types.Transaction, error) {
	return _Pool.Contract.Outflow(&_Pool.TransactOpts, tAddr, to, money)
}

// Outflow is a paid mutator transaction binding the contract method 0x530345bb.
//
// Solidity: function outflow(address tAddr, address to, uint256 money) payable returns()
func (_Pool *PoolTransactorSession) Outflow(tAddr common.Address, to common.Address, money *big.Int) (*types.Transaction, error) {
	return _Pool.Contract.Outflow(&_Pool.TransactOpts, tAddr, to, money)
}
...
// PoolAddOwnerIterator is returned from FilterAddOwner and is used to iterate over the raw logs and unpacked data for AddOwner events raised by the Pool contract.
type PoolAddOwnerIterator struct {
	Event *PoolAddOwner // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PoolAddOwnerIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PoolAddOwnerIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PoolAddOwnerIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PoolAddOwner represents a AddOwner event raised by the Pool contract.
type PoolAddOwner struct {
	From  common.Address
	IsSet bool
	Raw   types.Log // Blockchain specific contextual infos
}
...
//
// Solidity: event AddOwner(address from, bool isSet)
func (_Pool *PoolFilterer) FilterAddOwner(opts *bind.FilterOpts) (*PoolAddOwnerIterator, error) {

	logs, sub, err := _Pool.contract.FilterLogs(opts, "AddOwner")
	if err != nil {
		return nil, err
	}
	return &PoolAddOwnerIterator{contract: _Pool.contract, event: "AddOwner", logs: logs, sub: sub}, nil
}

// WatchAddOwner is a free log subscription operation binding the contract event 0x938b2a24c98e4e542127ffa74a91e48942c2bddccae3b6d75f82bfda7bbc0807.
//
// Solidity: event AddOwner(address from, bool isSet)
func (_Pool *PoolFilterer) WatchAddOwner(opts *bind.WatchOpts, sink chan<- *PoolAddOwner) (event.Subscription, error) {

	logs, sub, err := _Pool.contract.WatchLogs(opts, "AddOwner")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PoolAddOwner)
				if err := _Pool.contract.UnpackLog(event, "AddOwner", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event AddOwner(address from, bool isSet)
func (_Pool *PoolFilterer) ParseAddOwner(log types.Log) (*PoolAddOwner, error) {
	event := new(PoolAddOwner)
	if err := _Pool.contract.UnpackLog(event, "AddOwner", log); err != nil {
		return nil, err
	}
...
// PoolInflowIterator is returned from FilterInflow and is used to iterate over the raw logs and unpacked data for Inflow events raised by the Pool contract.
type PoolInflowIterator struct {
	Event *PoolInflow // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PoolInflowIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PoolInflowIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PoolInflowIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PoolInflow represents a Inflow event raised by the Pool contract.
type PoolInflow struct {
	From  common.Address
	TAddr common.Address
	Money *big.Int
	Raw   types.Log // Blockchain specific contextual infos
...
//
// Solidity: event Inflow(address indexed from, address tAddr, uint256 money)
func (_Pool *PoolFilterer) FilterInflow(opts *bind.FilterOpts, from []common.Address) (*PoolInflowIterator, error) {
	...
	logs, sub, err := _Pool.contract.FilterLogs(opts, "Inflow", fromRule)
	if err != nil {
		return nil, err
	}
	return &PoolInflowIterator{contract: _Pool.contract, event: "Inflow", logs: logs, sub: sub}, nil
}

// WatchInflow is a free log subscription operation binding the contract event 0xde52ea03a3979fafeaf8ea9d7fe6b3ddc6a95e9e8c0922562db3a047c0d72578.
//
// Solidity: event Inflow(address indexed from, address tAddr, uint256 money)
func (_Pool *PoolFilterer) WatchInflow(opts *bind.WatchOpts, sink chan<- *PoolInflow, from []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Pool.contract.WatchLogs(opts, "Inflow", fromRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PoolInflow)
				if err := _Pool.contract.UnpackLog(event, "Inflow", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Inflow(address indexed from, address tAddr, uint256 money)
func (_Pool *PoolFilterer) ParseInflow(log types.Log) (*PoolInflow, error) {
	event := new(PoolInflow)
	if err := _Pool.contract.UnpackLog(event, "Inflow", log); err != nil {
		return nil, err
	}
...
// PoolOutflowIterator is returned from FilterOutflow and is used to iterate over the raw logs and unpacked data for Outflow events raised by the Pool contract.
type PoolOutflowIterator struct {
	Event *PoolOutflow // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PoolOutflowIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PoolOutflowIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PoolOutflowIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PoolOutflow represents a Outflow event raised by the Pool contract.
type PoolOutflow struct {
	To    common.Address
	TAddr common.Address
	Money *big.Int
	Raw   types.Log // Blockchain specific contextual infos
...
//
// Solidity: event Outflow(address indexed to, address tAddr, uint256 money)
func (_Pool *PoolFilterer) FilterOutflow(opts *bind.FilterOpts, to []common.Address) (*PoolOutflowIterator, error) {
	...
	logs, sub, err := _Pool.contract.FilterLogs(opts, "Outflow", toRule)
	if err != nil {
		return nil, err
	}
	return &PoolOutflowIterator{contract: _Pool.contract, event: "Outflow", logs: logs, sub: sub}, nil
}

// WatchOutflow is a free log subscription operation binding the contract event 0x4eb2adb2eba0bb5546cc2e8d62ae0c32e7b6fb40567d53be433eb4b17f5f996e.
//
// Solidity: event Outflow(address indexed to, address tAddr, uint256 money)
func (_Pool *PoolFilterer) WatchOutflow(opts *bind.WatchOpts, sink chan<- *PoolOutflow, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Pool.contract.WatchLogs(opts, "Outflow", toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PoolOutflow)
				if err := _Pool.contract.UnpackLog(event, "Outflow", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Outflow(address indexed to, address tAddr, uint256 money)
func (_Pool *PoolFilterer) ParseOutflow(log types.Log) (*PoolOutflow, error) {
	event := new(PoolOutflow)
	if err := _Pool.contract.UnpackLog(event, "Outflow", log); err != nil {
		return nil, err
	}
